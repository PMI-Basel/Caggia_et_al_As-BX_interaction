---
title: "Arsenic Soil - 02: Taxanomy Analysis"
author: "Jan Waelchli"
geometry: margin=2cm
output:
  pdf_document:
...
## Figure 2.1 | abundances on phylum level
...
levels(bPHYSEQ_phyla_melt$Timepoint) <- c("0 months", "1 month", "2 months", "3 months", "4 months", "5 months")
...
levels(fPHYSEQ_phyla_melt$Timepoint) <- c("0 months", "1 month", "2 months", "3 months", "4 months", "5 months")
...
## Figure 2.2 | mean abundances on phylum level

```{r bac fig2, echo=F, warning=F, message=F, fig.height=10, fig.width=15}

bPHYSEQ_phyla_melt_trt <- bPHYSEQ_phyla_melt
bPHYSEQ_phyla_melt_trt$Arsenic_Timepoint <- paste0(bPHYSEQ_phyla_melt_trt$Arsenic, "_", bPHYSEQ_phyla_melt_trt$Timepoint)

#norm to 100% per Arsenic
for (t in unique(bPHYSEQ_phyla_melt_trt$Arsenic_Timepoint)) {
  abus <- bPHYSEQ_phyla_melt_trt$Abundance[bPHYSEQ_phyla_melt_trt$Arsenic_Timepoint == t]
  abus_norm <- 100 * abus/sum(abus)
  bPHYSEQ_phyla_melt_trt$Abundance[bPHYSEQ_phyla_melt_trt$Arsenic_Timepoint == t] <- abus_norm
}
...
fPHYSEQ_phyla_melt_trt$Arsenic_Timepoint <- paste0(fPHYSEQ_phyla_melt_trt$Arsenic, "_", fPHYSEQ_phyla_melt_trt$Timepoint)

#norm to 100% per Arsenic
for (t in unique(fPHYSEQ_phyla_melt_trt$Arsenic_Timepoint)) {
  abus <- fPHYSEQ_phyla_melt_trt$Abundance[fPHYSEQ_phyla_melt_trt$Arsenic_Timepoint == t]
  abus_norm <- 100 * abus/sum(abus)
  fPHYSEQ_phyla_melt_trt$Abundance[fPHYSEQ_phyla_melt_trt$Arsenic_Timepoint == t] <- abus_norm
}
