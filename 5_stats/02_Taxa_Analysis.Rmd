---
title: "Arsen - 02: Taxanomy Analysis"
author: "Jan Waelchli"
geometry: margin=2cm
output:
  pdf_document:
...
### Figure 4.1 | Bacteria: Phylum level taxonomy
...
bPHYSEQ_phyla_melt <- bPHYSEQ_phyla_melt[order(bPHYSEQ_phyla_melt$arsen),]
...
fig3.1 <- ggplot(bPHYSEQ_phyla_melt, aes_string(x="sample_ID", y="Abundance", fill="labels_2")) + 
  ...
  facet_grid( ~ arsen, scale="free_x", space="free_x") +
...
#png("figs_for_paper/fig3.1.png",5000,4500, res=600)
print(fig3.1)
#dev.off()
...
### Figure 4.2 | Fungi: Phylum level taxonomy
...
fPHYSEQ_phyla_melt <- fPHYSEQ_phyla_melt[order(fPHYSEQ_phyla_melt$arsen),]
...
#png("figs_for_paper/fig3.2.png",5000,4500, res=600)
print(fig3.2)
#dev.off()
...
We test if there are any difference between the phyla abundances between genotypes, arsen-treatments or their interaction by performing a PERMNOVA (permutations = 999).
...
bdist_paov <- vegan::adonis2(bdist ~ arsen*genotype, data=bDESIGN)
...
fdist_paov <- vegan::adonis2(fdist ~ arsen*genotype, data=fDESIGN)
