...
taxa_database <- "~/../GROUP/taxanomy_databases/sh_general_release_dynamic_02.02.2019.fasta"
##########################
...
for (run in runs) {
  ...
  path <- paste("../2_data/fungi/", run, sep="")
...
if(output){
  ...
  dataframe2fas(ASV_seq,  paste(path_out, "fungi_sequences.fasta", sep="")) #library seqRFLP
